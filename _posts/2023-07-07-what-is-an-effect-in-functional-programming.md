...
Thus, ChatGPT suggests that an “Effect” means “breakage of referential transparency.”

If you [check StackOverflow](https://stackoverflow.com/a/33398273), you might see that some people think that “breakage of referential transparency” should be called a “Side-Effect,” while “Effect” should stand for something that “distinguishes between the actual value and the ‘rest’” of an abstraction. Wait, what?
...
So, things may go *wild* when we talk about effects.

I would like to add yet another clarification here.
...
I should stress that “Unwanted Side-Effects” aren’t necessarily “Side-Effects” (they are not necessarily breakages of referential transparency), while “Side-Effects” have nothing in common with “Effects.”
...
What Haskell people call "Effect" has a less obscure name: **Aspect**. Moreover, it is [used](https://en.wikipedia.org/wiki/Aspect-oriented_programming) by many programmers with exactly that meaning.

What Haskell people call "Unwanted side effect" should be called simply **Side-Effect**. This term has very stable semantics in [medicine](https://en.wikipedia.org/wiki/Side_effect) and engineering. A **Side-Effect** is always "unwanted" in these domains, but not in the Haskell or broader computer science world.

It is interesting what to do with "Side-Effects" in Haskell. We might notice that there are two important classes of "Side-Effects." A function might violate referential transparency by "reading" from an external state or by "writing" into it, or by both. If we look at robotics, cybernetics, and medicine, we find two concepts: "afferent channel," meaning a way for a system, robot, or organism to perceive information from the outside world, and "efferent channel," which stands for a capability of a system, robot, or organism to change the outside world. These terms come from two words with Latin roots, ["Effect" and "Affect"](https://www.merriam-webster.com/words-at-play/affect-vs-effect-usage-difference). Three major scientific domains use these terms in their original meaning, including domains that predate computer science. So, I think that computer science should do the same: call referential-transparency violations caused by reading from the outside world **Affects**, and call changes made by a function to the outside world **Effects**.
